# EventResource Allocation

EventResource Allocation is a small Flask app for event scheduling and resource allocation. It provides a simple UI to create events, register resources, allocate resources to events, and generate utilization reports.
